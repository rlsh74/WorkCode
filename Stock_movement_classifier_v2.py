...
for ticker in tickers:
    try:
        ...
        res.to_excel('A_' + ticker+ '_' +str(K) + '_' + interval + '_signal.xlsx', index=False)
...
signals.to_excel('_All_signals.xlsx', index=False)

for ticker in tickers:
    try:
        df = pd.read_excel('A_' + ticker+ '_' +str(K) + '_' + interval + '_signal.xlsx')
